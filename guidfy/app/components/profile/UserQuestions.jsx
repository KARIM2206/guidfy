...
import QuestionCard from '../community/feed/QuestionCard';
...
// Main Component
// ───────────────────────────────
const UserQuestions = ({ questions = [], loading }) => {
  // Loading state
  if (loading) {
    return (
  ...
  return (
    <div className="space-y-4">
      {questions.map((question, index) => {
        ...
        const publishedDate = formatDate(question.createdAt);
        const excerpt = getExcerpt(question.body);
