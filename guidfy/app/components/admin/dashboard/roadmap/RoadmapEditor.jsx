...
//   );
// }
// components/roadmaps/RoadmapCard.jsx
'use client';
...
const RoadmapCard = ({ roadmap, onEdit, onDelete, onAddStep }) => {
  ...
  return (
    ...
    >
      ...
      <p className="text-sm text-gray-600 mb-1">التصنيف: {roadmap.category}</p>
      <p className="text-sm text-gray-600 mb-1">المستوى: {roadmap.level}</p>
      <p className="text-sm text-gray-600 mb-3">المدة: {roadmap.estimatedDuration} دقيقة</p>
      <div className="flex gap-2 justify-end">
        <Button variant="outline" size="sm" onClick={() => router.push(`/roadmaps/${roadmap.id}`)}>
          <Eye size={16} />
        </Button>
        <Button variant="outline" size="sm" onClick={() => onEdit(roadmap)}>
          <Edit size={16} />
        </Button>
        <Button variant="danger" size="sm" onClick={() => onDelete(roadmap.id)}>
          <Trash2 size={16} />
        </Button>
        <Button variant="primary" size="sm" onClick={() => onAddStep(roadmap)}>
          <PlusCircle size={16} />
        </Button>
      </div>
    </motion.div>
