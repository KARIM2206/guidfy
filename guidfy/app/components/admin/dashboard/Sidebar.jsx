...
export default function Sidebar() {
  ...
  return (
    <motion.aside
      ...
      className={`flex flex-col bg-gradient-to-b from-gray-900 to-gray-800 text-white h-screen shadow-2xl ${
...
>
  <div className="flex items-center space-x-3 group">
    ...
    <motion.div
      className="relative p-2 bg-blue-600 rounded-lg cursor-pointer"
    >
      {/* Logo */}
      <motion.div
